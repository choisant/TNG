...
#safe_tester.cleanup("tng-100-3", "aspire_test_vel_disp2")
...
cat = pd.read_pickle("./data/tng-100-3/catalogues/aspire_test_vel_disp2.pkl")
cat["p"] = 100*cat["SubhaloVelDisp3D_Stellar_Total_MW"]/cat["SubhaloVelDisp3D_Stellar_Total"]
cat.plot.scatter("SubhaloMassStellarTotal", "p")
plt.show()